...
function initScrollAnimations() {
  ...
  const animatedElements = document.querySelectorAll(
    ".background__content, .comparison-card, .css-comparison, .interactive-demo, .badge-selector, .advantage-card, .summary"
  );
...
function initAccordionInteractions() {
  const accordionItems = document.querySelectorAll(".demo-accordion-item");
  ...
  accordionItems.forEach((item) => {
    item.addEventListener("click", function () {
      ...
      } else if (this.classList.contains("demo-accordion-item--icon-down")) {
        iconType = "down-arrow";
      } else if (this.classList.contains("demo-accordion-item--icon-right")) {
        iconType = "right-arrow";
      } else if (this.classList.contains("demo-accordion-item--icon-plus")) {
        iconType = "plus";
      }
